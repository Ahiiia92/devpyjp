...
def semantic_search_quora(esarch_text):
    ...
    # Defining our hnswlib index We use Inner Product (dot-product) as Index. We will normalize our vectors to unit
    # length, then is Inner Product equal to cosine similarity
